...
const ManageEnrolment = ({ emailEnrolment:{email}, deleteEmailEnrolment, accessToken }) => {
  return (
    <div className="row" style={{ "margin-top": 25 }} >
      ...
      <div className="col-xs-12">
          <Button bsStyle="danger" onClick={()=>deleteEmailEnrolment(email, accessToken)}>Delete</Button>
      </div>
    </div>
  );
}
